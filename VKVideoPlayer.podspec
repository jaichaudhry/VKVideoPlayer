Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/jaichaudhry/VKVideoPlayer.git", :tag => s.version.to_s }
  ...
  s.dependency 'VKFoundation', :git => 'https://github.com/jaichaudhry/VKFoundation.git'
